				...
				<div class='wrap'>
					<div class="site-branding">
						...
						if ( function_exists( 'the_custom_logo' ) && get_custom_logo() ) :
							...
							$logo_image_url = get_theme_mod( 'brainpress_logo', get_template_directory_uri() . '/images/logo-default.png' );
						?>
							<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
								<?php if ( empty( $logo_image_url ) ) : ?>
									<?php echo get_bloginfo( 'name' ); ?>
								<?php else : ?>
									<img id="brainpress_logo" src="<?php echo esc_url( $logo_image_url ); ?>" alt="<?php bloginfo( 'name' ); ?>" border="0" />
								<?php endif; ?></a>
							</h1>
						<?php endif; ?>
					</div>
